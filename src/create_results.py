...
"""
    ...
    def create_metrics_files(self):
        ...
        metrics_dir = self.results_dir / "05_metrics"
...
"""
    ...
    def create_model_files(self):
        ...
        models_dir = self.results_dir / "04_models"
        
        model_info = """# Trained Models Information
...
""".format(timestamp=self.timestamp)
        ...
        (models_dir / "MODEL_INFO.md").write_text(model_info)
        
        print("Created model information files")
...
""".format(timestamp=self.timestamp)
    ...
    def create_diagnostic_files(self):
        ...
        diagnostics_dir = self.results_dir / "06_diagnostics"
...
""".format(timestamp=self.timestamp)
    ...
    def create_log_files(self):
        ...
        logs_dir = self.results_dir / "07_logs"
...
""".format(timestamp=self.timestamp)
    ...
    def generate_all(self):
        ...
        print("2. Metrics: cat results/05_metrics/overall_metrics.json")
